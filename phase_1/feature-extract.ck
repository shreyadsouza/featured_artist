...
//exp2
// fft =^ MFCC mfcc1 =^ combo;
// fft =^ MFCC mfcc2 =^ combo;
// fft =^ MFCC mfcc3 =^ combo;
// fft =^ MFCC mfcc4 =^ combo;
// fft =^ MFCC mfcc5 =^ combo;
...
for( int i; i < labels.size(); i++)
{
    ...
    {
        // construct filepath
        "/Users/shreyadsouza/Desktop/courses/win_24/musc_356_cs_470/featured_artist/phase_1/genres_original/" + label + "/" + label + ".000" + (j<10?"0":"") + j + ".wav" => filename;
        // extract the file
